              ...
              <div className="card-g row" key={employee.employeeId}>
                <div className="col-sm-5">
                  ...
                  <div className="info">
                    ...
                    <p>
                      <h7>Department:</h7> {employee.department}
                    </p>
                    <p>
                ...
                <div className="card-body col-sm-7">
                  <p>
                    <h7>DOB:</h7> {formattedBirthDate}
                  </p>
                  <p>
                    <h7>Phone:</h7> {employee.phoneNumber}
                  </p>
                  <p>
                    <h7>Email:</h7> {employee.emailAddress}
                  </p>
                  <p>
                    <h7>Address:</h7> {employee.address}
                  </p>
                  <p>
                    <h7>Passport Number:</h7> {employee.passport}
                  </p>
                  <p>
                    <h7>EPF Number:</h7>
                    {employee.epfNumber}
                  ...
                  <p>
                    <h7>Start Date:</h7> {formattedStartDate}
                  </p>
